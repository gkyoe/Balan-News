...
var Tabloid = /** @class */ (function (_super) {
    ...
    function Tabloid(props, state) {
        ...
        _this.requestCrawlingNews = function (apicollection) {
            axios_1.default
                ...
                .then(function (value) {
                _this.setState(__assign(__assign({}, _this.state), { upadateNews: value }));
            })
    ...
    //   });
    // }
    Tabloid.getDerivedStateFromProps = function (nextprops, nextstate) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("getDerivedStateFromProps is working");
                        return [4 /*yield*/, nextprops.news.map(function (el) {
                                axios_1.default
                                    ...
                                    if (response.status === 200) {
                                        ...
                                        return { upadateNews: response.data };
                                    }
                                    else {
    ...
    Tabloid.prototype.render = function () {
        return (React.createElement("ul", null, this.state.upadateNews.map(function (data, idx) {
