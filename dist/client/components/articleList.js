...
var ArticleList = /** @class */ (function (_super) {
    ...
    ArticleList.prototype.render = function () {
        var _this = this;
        var handleCheck = function (e) { return __awaiter(_this, void 0, void 0, function () {
            var checkedBoolean, checkClickBox, addCrawlindData, selectedArticle;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        addCrawlindData = function (preData) {
                            axios_1.default
                        ...
                        return [4 /*yield*/, this.props.news];
                    case 1:
                        selectedArticle = _a.sent();
                        return [4 /*yield*/, addCrawlindData(selectedArticle)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
